...
%         .substract = 1 - F_k(t)
%         .grad_b = gradient of ( 1- F_c(t)) wrt to b !!!!
...
%%
    term = -u1.*x + u2.*z - x1./w2 + z1./w2; 
    ind_Fk = term<=10^-300;      % to avoid numerically zero
    term(ind_Fk) = 10^-300;      % to avoid numerically zero
    ...
    if (gradient == true)
        ...
        output.grad_b = -grad_b; % NOTE: term = 1- F_k(t)
        output.grad_A = -grad_A; % NOTE: grads here are of ( 1 - F_k(t)) !!!
