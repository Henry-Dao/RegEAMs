%% Description:
% This is the main code for running VBL for RegLBA.
%
...
elseif VB_settings.Initialization_Strategy == "MLE"
    MLE_model = model;
    MLE_model.matching_parameters = str2func("Matching_Parameters_HLBA");
    MLE_model.matching_gradients = str2func("Matching_Gradients_HLBA");
    MLE_model.objective_function = str2func("minus_log_lba_nobeta_density");
    mle = zeros(D_alpha,J);
