...
%% Step 0: ----------------------- PREPERATION ----------------------------
    ...
    load('Lexical_Real_data.mat') % load the data
    
    save_path = '';
    save_name = 'MCMC_Results';
...
%% Step 2: ------------------------ MCMC Setting --------------------------
    ...
    MCMC_setting.CMC_beta = str2func("CMC_beta_with_covariates"); % name of the CMC_alpha function

    MCMC_setting.when_to_reduce_the_numer_particles = 1000;
    MCMC_setting.CMC_alpha_number_particles = 350; % number of particles in the conditional Monte Carlo algorithm  
    ...
    MCMC_setting.CMC_beta_number_particles = 150; % number of particles in the conditional Monte Carlo algorithm  
    MCMC_setting.CMC_beta_number_particles_after = 100;
    ...
    MCMC_setting.number_samples = 5000; % number of draws used to estimate the covariance matrix in the proposal    
