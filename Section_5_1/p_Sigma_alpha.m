function output = p_Sigma_alpha_v2(Sigma_alpha,v,v_a,Psi,alpha,mu_alpha,a)
...
% Email: viethung.unsw@gmail.com
    ...
    output.log = 0.5*v*logdet(Psi,'chol') - 0.5*v*p*log(2) - log_multigamma(v/2,p) -...
        0.5*(v+p+1)*logdet(Sigma_alpha,'chol') - 0.5*trace(Psi*Sigma_alpha_inv);
