function [f,g] = minus_log_hddm_withbeta_density_vagueprior(x,subject_j,MLE_model)
% INPUT: x = [alpha_j, beta_vec];
% OUTPUT: f = - log pdf
%         g = [grad_alpha_j grad_beta_vec]
% alpha_j ~ N(0,10*I) , beta_vec ~ N(0,10*I)

D_alpha = MLE_model.num_random_effects;
alpha_j = x(1:D_alpha);
...
covmat_alpha=10*eye(D_alpha);
covmat_beta=10*eye(prod(MLE_model.beta_dim));
