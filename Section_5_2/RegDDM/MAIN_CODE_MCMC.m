...
%% Step 1: -------------------- Model specification ----------------------- 
    ...
    HDDM_Model_Specification_ERPdata
...
%% Step 2: ------------------------ MCMC Setting --------------------------
    ...
    MCMC_setting.CMC_alpha_number_particles_after = 100;
    ...
    MCMC_setting.CMC_beta_number_particles = 350; % number of particles in the conditional Monte Carlo algorithm  
